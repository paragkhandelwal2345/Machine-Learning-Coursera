...
h_theta = sigmoid(z3);%10 x 5000
a3 = h_theta';%5000 x 10
y_new = zeros(size(h_theta));%10 x 5000
for i=1:m,
  y_new(y(i),i) = 1;
endfor
...
for i=1:m,
  ...
  Z3 = Theta2*A2';%10 x 1
  A3 = sigmoid(Z3);
  del3 = A3 - y_new(:,i);%10 x 1
  Z2 = [1;Z2];%26 x 1
  del2 = (Theta2'*del3).*sigmoidGradient(Z2);%26 x 1
  del2 = del2(2:size(del2,1));%25 x 1
